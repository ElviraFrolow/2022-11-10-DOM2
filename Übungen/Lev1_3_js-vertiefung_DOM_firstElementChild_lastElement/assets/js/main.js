...
console.log(document.body.firstElementChild.children[0].innerHTML);
console.log(document.body.firstElementChild.lastElementChild.innerText);
...
btn[0].addEventListener(`click`, () => {
  output.innerHTML = document.body.firstElementChild.children[0].innerHTML;
});
btn[1].addEventListener(`click`, () => {
  output.innerHTML = document.body.firstElementChild.lastElementChild.innerText;
});
btn[2].addEventListener(`click`, () => {
  output.innerHTML = document.body.firstElementChild.children[1].innerHTML;
});
btn[3].addEventListener(`click`, () => {
  output.innerHTML = document.body.firstElementChild.children[5].innerHTML;
});
